...
taboaContidos[0]=new act("Quimica","Quimica","","<object width='100%' height='420' type='text/html' data='Crucigrama/Crucigrama.htm'></object>",false,"",true,true,true);
taboaContidos[1]=new act("Ingles","Ingles","","<object width='100%' height='420' type='text/html' data='Ingles/Ingles.htm'></object>",false,"",true,true,true);
taboaContidos[2]=new act("Matemáticas","Matemáticas","","<object width='100%' height='420' type='text/html' data='Multiplicaciones/Multiplicaciones.htm'></object>",false,"",true,true,true);
taboaContidos[3]=new act("Biología","Biología","","<object width='100%' height='420' type='text/html' data='bio/bio.htm'></object>",false,"",true,true,true);
taboaContidos[4]=new act("Literatura Española","Literatura Española","","<object width='100%' height='420' type='text/html' data='literatura/literatura.htm'></object>",false,"",true,true,true);
taboaContidos[5]=new act("Lengua","Lengua","","<object width='100%' height='420' type='text/html' data='lengua/lengua.htm'></object>",false,"",true,true,true);
