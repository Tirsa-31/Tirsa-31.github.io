...
$("#ardoraQuest").html("<img id='playSound' class='imaLeft' src='bio_resources/media/' alt='Sound' align='left'>"+ "<p>" + questionW[indexG] + "</p>");
...
$("#ardoraActCanvas").focus();
$("#ardoraActCanvas").bind("click keypress", function (e) {$("#ardoraActCanvas").unbind();document.getElementById("ardoraActCanvas").style.zIndex = 0;
...
$(".bLetter").attr("tabindex","0");$("#ardoraActCanvas").attr("tabindex","0");$(".bLetter").focus(function(e) {$(this).css("backgroundColor",colorSele);});$(".bLetter").blur(function(e) {$(this).css("backgroundColor",colorButton);});$(".bLetter").keypress(function(e) {if (e.which!=9){checkLetter($(this));}});});
}
function isCorrect(){
}
